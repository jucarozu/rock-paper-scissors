...
use Uniqoders\Game\Strategies\Rounds\PaperAgainstLizardRoundStrategy;
use PHPUnit\Framework\TestCase;

class PaperAgainstLizardRoundStrategyTest extends TestCase
{
    /**
     * @return void
     */
    ...
    {
        // Arrange
        $roundStrategy = new PaperAgainstLizardRoundStrategy();
